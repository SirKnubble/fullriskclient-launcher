...
This Repository includes all bugfixes and features of [NoRiskClient/issues](https://github.com/NoRiskClient/issues/issues) by @SirKnubble, that didn´t get approved in pull-requests,  
